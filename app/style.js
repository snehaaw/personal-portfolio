...
sectionDescription:
  "text-[18px] sm:text-[20px] text-gray-800 leading-[28px] sm:leading-[32px] max-w-[700px] mx-auto",
resumeButton:
  "mt-6 bg-teal-600 hover:bg-teal-800 text-white text-[16px] py-3 px-6 rounded-lg font-medium shadow-lg transition-all duration-300",
